...
const Player = function(
    ...
    const update = function(time) {
        ...
        walls.forEach((e) => {
            if (
                ...
                .getBoundingBox()
                .isPointInBox(
                    x + sequences.idleDown.width,
                    y + sequences.idleDown.height + this.velocity
                ) ||
                e
                .getBoundingBox()
                .isPointInBox(
        ...
        if (id === 1) {
            if (
                end.collide(this.getBoundingBox()) &&
                gameState.player1.cherryLeft === 0
            ) {
            ...
            if (
                ...
                gameState.player2.cherryLeft === 0
            ) {
                gameState.finish = true;
                gameState.winId = 2;
            }
        ...
        if (
            y + sequences.idleLeft.height + this.velocity <= gameArea.getBottom() &&
            !isGround
        ) {
        ...
        if (direction != 0) {
            ...
            switch (direction) {
                ...
                case 3:
                    if (
                        y + sequences.idleLeft.height >= gameArea.getBottom() ||
                        isGround
                    ) {
                        this.velocity -= 11;
                        direction = 0;
    ...
    const sync = function(curTotalDistance, y) {
        sprite.setY(y);
        console.log("Distance", totalDistance, curTotalDistance);
        moveBack(curTotalDistance - totalDistance);
